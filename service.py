import socket, json, threading, sys, time, logging, os, asyncio
...
def tcp_recv():
    ...
    while server_connected and service_active:
        try:
            status = dev_serial.write(dev_serial.recv(PACKET_MAX_SIZE))
